...
# -*- coding: utf-8 -*-
"""\
*    *[Summary]* :: =bearerTokenProc=: Generate, Validate and Decode Bearer Tokens.
"""

####+BEGIN: bx:icm:python:top-of-file :partof "cible" :copyleft "none"
"""
*  This file:/de/bx/nne/dev-py/pypi/pkgs/unisos/mmwsIcm/dev/bin/bearerTokenProc.py :: [[elisp:(org-cycle)][| ]]
...
__icmName__ = "bearerTokenProc"
####+END:

####+BEGIN: bx:global:timestamp:version-py :style "date"
__version__ = "201809101053"
####+END:
